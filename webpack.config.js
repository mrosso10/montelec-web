...
module.exports = {
  ...
  "entry": {
    ...
    "scripts": [
      ...
      "script-loader!./node_modules/metismenu/dist/metisMenu.js",
      "script-loader!./src/vendor/pace/pace.min.js",
    ...
    "rules": [
      ...
      },
      {
        "exclude": [
          ...
          path.join(process.cwd(), "src/assets/styles/styles.css")
        ],
        "test": /\.css$/,
        "use": [
  ...
  "plugins": [
    ...
    new GlobCopyWebpackPlugin({
      ...
      "globOptions": {
        "cwd": "/home/martin/repo/montelec-web/src",
        "dot": true,
        "ignore": "**/.gitkeep"
      }
    }),
